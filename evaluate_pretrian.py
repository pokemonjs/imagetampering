...
# load
# print(save_dir)
layer_state_dict = paddle.load("{}/{}".format(save_dir, file_name.replace("maxf1", "")))
print("{}/{}".format(save_dir,
                     file_name.replace("maxf1", "")))

# layer_state_dict = paddle.load("{}/{}".format(save_dir, "final.resunet.columbia_aug.finetune - 副本.pdparams"))
# layer_state_dict = paddle.load("rrunet_pth/dual_ca_se_afusion_rrunet/final.dual_ca_se_afusion_rrunet.CASIA.5972.finetune.pdparams")
