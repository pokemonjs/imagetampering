...
def normalize(img, mask=None):
    ...
    img = transforms.Compose([
        ...
        # transforms.Normalize([0.4123, 0.4481, 0.4420], [0.2862, 0.2553, 0.2642])  # SAN
        # transforms.Normalize([0.39225175, 0.43358087, 0.44139242], [0.28549757, 0.26002468, 0.26558968])  # CASIA
    ])(img)
    if mask is not None:
